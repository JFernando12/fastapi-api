...
def get_project(project_id: str, db: Session = Depends(get_db)):
    projects = project_service.get_project(db, project_id=project_id)
...
def create_project(project_data: ProjectCreate, db: Session = Depends(get_db)):
    projects = project_service.create_project(db, project_data=project_data)
...
def update_project(project_id: str, project_data: ProjectCreate, db: Session = Depends(get_db)):
    project = project_service.update_project(db, project_id=project_id, project_data=project_data)
